...
\addbibresource{TrajOptSurvey.bib}
...
\begin{document}
    ...
    Building off of this existing work, we propose two novel research directions.
    First, we propose a method for low-cost dynamics emulation of arbitrary
    aerospace systems using multicopters, leveraging much of the work on online
    trajectory optimization detailed in this thesis. Second, we propose to
    further push the computational limits of nonlinear trajectory optimization
    with algorithms that are more naturally suited to parallelization.
    ...
    \part{Proposed Work} \label{part:proposal}
    \subfile{chapters/07_blimp.tex}
    \subfile{chapters/08_parallelization.tex}
    \subfile{chapters/09_conclusion.tex}    
